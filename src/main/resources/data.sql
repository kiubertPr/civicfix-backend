...
-- Nuevos Posts con fechas variadas (H2 DATEADD → PostgreSQL INTERVAL)
INSERT INTO posts (title, content, location, latitude, longitude, date, userId, category) VALUES
('Bache peligroso en esquina', 'Gran bache en la esquina de Calle Rosalía. Representa un peligro para vehículos y peatones. Urge reparación.', 'Calle Rosalía, 10', 43.3622, -8.4089, CURRENT_TIMESTAMP - INTERVAL '2 days', 7, 'USER'),
('Árbol caído en la intersección', 'En la intersección de Calle Real y Av. del Mar hay un árbol caído obstruyendo el paso peatonal. Se requiere intervención.', 'Calle Real y Av. del Mar', 43.3661, -8.3998, CURRENT_TIMESTAMP - INTERVAL '5 days', 8, 'USER'),
('Acera rota en parque', 'Las losetas de la acera en el parque de San Pedro están levantadas y rotas. Podrían causar caídas.', 'Parque de San Pedro', 43.3591, -8.4182, CURRENT_TIMESTAMP - INTERVAL '7 days', 9, 'USER'),
('Jornada de limpieza comunitaria', 'El sábado próximo se organiza limpieza en la playa de Riazor. ¡Participa!', 'Playa de Riazor', 43.3719, -8.4127, CURRENT_TIMESTAMP - INTERVAL '10 days', 1, 'ADMINISTRATION'),
('Mejora de accesibilidad peatonal', 'Una señal de stop está caída en la Calle Barcelona. Se realizarán mejoras de accesibilidad en la zona peatonal.', 'Calle Barcelona, 22', 43.3730, -8.4050, CURRENT_TIMESTAMP - INTERVAL '3 days', 11, 'USER'),
('Obras en el centro cívico', 'Durante esta semana se desarrollarán obras de mejora en la zona peatonal del centro cívico. Se recomienda transitar con precaución.', 'Centro Cívico A Coruña', 43.3617, -8.4092, CURRENT_TIMESTAMP - INTERVAL '4 days', 1, 'ADMINISTRATION'),
('Tapa de alcantarilla rota', 'Hay una tapa de alcantarilla rota frente al número 33 de Calle Estrella. Representa un peligro.', 'Calle Estrella, 33', 43.3675, -8.4021, CURRENT_TIMESTAMP - INTERVAL '9 days', 4, 'USER'),
('Sombra solicitada para juegos', 'Los juegos del parque de la Calle Lago carecen de sombra. Propongo instalar toldos.', 'Calle Lago, Parque Infantil', 43.3659, -8.4003, CURRENT_TIMESTAMP - INTERVAL '14 days', 5, 'USER'),
('Fuga de agua persistente', 'Hay una fuga constante de agua en un callejón sin nombre detrás del mercado.', 'Callejón del Mercado', 43.3633, -8.3975, CURRENT_TIMESTAMP - INTERVAL '6 days', 6, 'USER'),
('Taller de compostaje urbano', 'Se dictará un taller gratuito de compostaje urbano el viernes en el centro cultural San Agustín. ¡Inscríbete!', 'Centro Cultural San Agustín', 43.3589, -8.4101, CURRENT_TIMESTAMP - INTERVAL '12 days', 1, 'ADMINISTRATION');

-- Imágenes de los 10 nuevos posts
INSERT INTO posts_images (postsId, publicId, url) VALUES 
...
('¿Qué opinas sobre la calidad del servicio de transporte público?', CURRENT_TIMESTAMP - INTERVAL '5 days', CURRENT_TIMESTAMP - INTERVAL '5 days', 0),
('¿Cuál es tu opinión sobre la seguridad en el barrio?', CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP + INTERVAL '2 days', 0),
('¿Qué mejoras te gustaría ver en el parque central?', CURRENT_TIMESTAMP - INTERVAL '10 days', CURRENT_TIMESTAMP + INTERVAL '10 days', 1),
('¿Cómo calificarías la limpieza de las calles de la ciudad?', CURRENT_TIMESTAMP - INTERVAL '1 days', CURRENT_TIMESTAMP + INTERVAL '1 days', 0),
('¿Qué tipo de eventos culturales te gustaría que se organizaran?', CURRENT_TIMESTAMP - INTERVAL '7 days', CURRENT_TIMESTAMP + INTERVAL '7 days', 1);
